                ...
                <div className="bg-indigo-50 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    <div className="bg-white rounded-lg p-4 shadow-sm">
                      ...
                      <p className="text-base font-bold text-gray-800">{latestData.timestamp}</p>
                    </div>
                    <div className="bg-white rounded-lg p-4 shadow-sm">
                      <p className="text-xs text-gray-600 mb-1">Total Count</p>
                      <p className="text-base font-bold text-indigo-600">{latestData.total_present_inside}</p>
                    </div>
                    <div className="bg-white rounded-lg p-4 shadow-sm">
                      <p className="text-xs text-gray-600 mb-1">Latest Incoming</p>
                      <p className="text-base font-bold text-green-600">{latestData.incoming_last_interval}</p>
                    </div>
                    <div className="bg-white rounded-lg p-4 shadow-sm">
                      <p className="text-xs text-gray-600 mb-1">Latest Outgoing</p>
                      <p className="text-base font-bold text-red-600">{latestData.outgoing_last_interval}</p>
                    </div>
                  </div>
                </div>
              )}
